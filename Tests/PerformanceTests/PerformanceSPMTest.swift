...
class GeneratedPerformanceSPMTests: XCTestCase {

    let basePath = Path.temporary + "XcodeGenPeformanceSPMTests"
...
let fixturePathSPM = Path(#file).parent().parent() + "Fixtures"

class FixturePerformanceTestsSPM: XCTestCase {

    let specPath = fixturePathSPM + "SPM/project.yml"
